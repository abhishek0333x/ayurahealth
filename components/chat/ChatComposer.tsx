        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 0.25rem' }}>
            <div style={{ display: 'flex', gap: '0.4rem' }}>
              <input ref={fileInputRef} type="file" accept="image/*,.pdf" multiple onChange={onFileSelect} style={{ display: 'none' }} aria-label="Upload files" />
              <button 
              ...
              <button 
                ...
                aria-label={showLinkInput ? "Cancel link input" : "Add link"}
                title={showLinkInput ? "Cancel link input" : "Add link"}
                style={{ 
                  width: 36, height: 36, borderRadius: '10px', 
